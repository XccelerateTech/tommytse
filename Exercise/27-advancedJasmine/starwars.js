...
function duel(obiwan, anakin) {
  console.log(
    "Obiwan and anakin yelled at each other.And then they started to fight."
  );
  ...
  console.log(
    "Obiwan stepped on the bank of the river. Anakin tried to gain a upperhand by jumping recklessly. Obiwan severed his left arm and both legs "
  );
  ...
  setTimeout(function() {
    console.log(
      "Anakin is rescued by Darth Sidious and completely transformed to the look of Darth Vader we normally known."
    );
    anakin.health = 800;
    anakin.power = 90;
  }, 5000);
